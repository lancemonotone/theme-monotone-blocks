...
( function ( blocks, element, blockEditor ) {
    ...
    const block = registerBlockType( 'monotone-blocks/jobs', {
        ...
        example: { attributes: { show_archive_link: '' } },
        edit: function ( props ) {
            const blockProps = useBlockProps({ 'data-pg-hidden': null });
