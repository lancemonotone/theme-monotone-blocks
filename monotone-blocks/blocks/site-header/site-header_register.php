<?php
        ...
        PG_Blocks_v2::register_block_type( array(
            'name' => 'monotone-blocks/site-header',
            'title' => __( 'Site Header', 'monotone_blocks' ),
            ...
            'enqueue_view_script' => get_template_directory_uri() . '/blocks/site-header/block-site-header.js',
